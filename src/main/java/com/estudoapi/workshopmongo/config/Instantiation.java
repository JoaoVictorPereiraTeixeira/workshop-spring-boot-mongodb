package com.estudoapi.workshopmongo.config;
...
import com.estudoapi.workshopmongo.dto.AuthorDTO;
import com.estudoapi.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null,sdf.parse("21/03/2018"),"Partiu viagem", "Vou viajar SAMPA",new AuthorDTO(maria));
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!",sdf.parse("21/03/2019"),new AuthorDTO(alex));
